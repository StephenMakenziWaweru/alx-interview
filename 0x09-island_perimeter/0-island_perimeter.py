...
def island_perimeter(grid):
    ...
    # logic is to check if the cell is surrounded by water or land on either of
    # top, bottom, left, right sides
    # if either side is not water, then subtract 1 from cell_perimeter then add remaining
    # cell perimeter to perimeter - do for all cells
